/**
 * Common Lisp - Syntaxhighlighter brush
 *
 * @version 0.1.1
...
(function() {
	function Brush()
	{
		var funcs = 
			...
			'signed-byte cdr length signum ceiling simple-condition cell-error let\\* ' +
		...
		this.regexList = [
        	...
        	{ regex: new RegExp('\\s:\\w[a-z_0-9-]*\\b', 'g'), css: 'keyword' },
        	{ regex: new RegExp(';.*', 'g'), css: 'comments' },
        	{ regex: new RegExp("\\b'(\\w[a-z_0-9-]*:)?\\w[a-z_0-9-]*", 'g'), css: 'symbol' },
